...
export function CosmicBackground() {
  ...
  return (
    <div className="pointer-events-none fixed inset-0 z-0 overflow-hidden bg-[#01030a]">
      ...
      <motion.div style={{ y: yFast }} className="stars-layer stars-layer-two z-0 hidden sm:block" />
      <div className="absolute -left-36 top-20 z-0 hidden size-[34rem] rounded-full bg-cyan-950/25 blur-3xl animate-float sm:block" />
      <div className="absolute -right-36 bottom-10 z-0 hidden size-[40rem] rounded-full bg-fuchsia-950/25 blur-3xl animate-float-delayed sm:block" />
      <div className="absolute left-1/3 top-1/2 z-0 hidden size-[30rem] rounded-full bg-violet-950/20 blur-3xl animate-pulse-slow md:block" />
